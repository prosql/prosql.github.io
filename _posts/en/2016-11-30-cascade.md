...
lang: en
layout: post
title: Cascading Delete of Related Data
---

In an ORACLE database, you need to delete a record from a table, but there are related records in other tables.
In such cases, when attempting to delete, we get the ORA-022292 error.

How to delete all related records?

A script that outputs delete commands for all related records in DBMS_OUTPUT:
